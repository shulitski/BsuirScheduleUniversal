    ...
    public class PairVM
    {
        ...
        public PairVM()
        {
            Pair pair = new Pair
            {
                ...
                subject = "ОСиСП",
                numSubgroup = 2,
                employee = new List<EmployeeApi.Employee>
                {
                    new EmployeeApi.Employee {lastName = "Конь", firstName = "Игорь", middleName = "Генадиевич", rank = "Профессор"}
                },
                lessonType = "ЛР",
        ...
        public Brush AuditoryColor => (Auditory.LastOrDefault() == '4') 
